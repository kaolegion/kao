...
## ROUT-7 — Routing Behavioral Heat Surface

Routing heat is now generated by an external cognitive observer.

### UX semantics

The operator must interpret routing heat as:

- stabilized routing preference
- cognitive intensity of provider usage
- long-term routing dynamics rather than instantaneous activity

### Event interpretation model

Heat increases only when:

- a new effective provider switch occurs
- the routing cognition posture changes

Heat does NOT increase when:

- retry loops occur
- gateway probing occurs
- internal router arbitration noise occurs

### UX projection

Future cockpit layers may derive:

- routing behavioral heat maps
- adaptive routing confidence indicators
- predictive provider arbitration hints
- session cognition temperature curves

ROUT-7 establishes the transition from:
