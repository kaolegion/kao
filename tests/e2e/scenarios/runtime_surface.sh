...
"${ROOT_DIR}/lib/runtime/live_capture.sh" capture COMMAND_RUN "kao status"
"${ROOT_DIR}/lib/runtime/live_capture.sh" capture SESSION_OPEN "session-e2e"
"${ROOT_DIR}/lib/runtime/live_capture.sh" capture UNKNOWN_EVENT "payload-e2e"
...
printf 'OK: runtime_surface inline normalizer\n'
